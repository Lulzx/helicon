...
MagNozzleX wraps and extends [WarpX](https://ecp-warpx.github.io/) with:
...
pip install magnozzlex[optimize]
```

## Quick Start

```python
from magnozzlex.fields.biot_savart import Coil, Grid, compute_bfield
...
**What makes MagNozzleX different:**
...
MagNozzleX is open-source, GPU-accelerated (MLX on Apple Silicon, CUDA via WarpX), and
validation-first.

## Citing MagNozzleX

See [CITATION.cff](https://github.com/magnozzlex/magnozzlex/blob/main/CITATION.cff) or cite as:

```bibtex
@software{magnozzlex,
  title = {MagNozzleX: GPU-Accelerated Magnetic Nozzle Simulation Toolkit},
  version = {0.4.0},
  license = {MIT},
}
```
