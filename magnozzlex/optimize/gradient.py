...
backend in :mod:`magnozzlex.fields.biot_savart`.
...
::
    ...
    from magnozzlex.fields.biot_savart import Grid
...
def _require_mlx() -> None:
    ...
    if not HAS_MLX:
        raise ImportError(
            ...
            "Install with: pip install 'magnozzlex[mlx]'"
        )
...
def optimize_mirror_ratio(
    ...
    *,
    ...
    :func:`~magnozzlex.fields.biot_savart.compute_bfield_mlx_differentiable`
