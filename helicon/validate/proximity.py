"""Validation proximity metric for Helicon (§7.3).

Computes the ``validation_proximity`` field — the parameter-space distance
from a user's :class:`~helicon.config.parser.SimConfig` to the nearest
...
class ProximityResult:
    """Distance from a :class:`~helicon.config.parser.SimConfig` to the
